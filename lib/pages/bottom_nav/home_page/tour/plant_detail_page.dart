...
class _PlantDetailPageState extends State<PlantDetailPage> {
  ...
  Future<void> checkIfFavorite() async {
    ...
    if (userDoc.exists) {
      ...
      setState(() {
        isFavorite = favorites.contains(widget.herbName);
      });
    }
  }
        ...
        actions: [
          ...
          IconButton(
            ...
            icon: Icon(
              ...
              color: isFavorite ? Colors.red : Color(0xFFF39C12),
            ),
            onPressed: () async {
              final user = FirebaseAuth.instance.currentUser;
              ...
              if (isFavorite) {
                ...
                await userDoc.update({
                  'favorites': FieldValue.arrayRemove([widget.herbName]),
                });
              } else {
                // Add plant to favorites
                await userDoc.set({
                  'favorites': FieldValue.arrayUnion([widget.herbName]),
